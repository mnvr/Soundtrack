...
public func logInfo(_ item: Any, tag: String? = nil, file: StaticString = #file, line: UInt = #line, function: StaticString = #function) {
...
public func logWarning(_ item: Any = String(), file: StaticString = #file, line: UInt = #line, function: StaticString = #function) {
    let message = "\(item)"
